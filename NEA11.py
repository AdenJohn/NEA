...
class Application(ttk.Window): 
    ...
    def show_orderadd(self): 
        ...
        self.date_orderadd_date = ttk.DateEntry(frame, bootstyle="DANGER", dateformat="%Y-%m-%d", startdate=datetime.today())
        ...
        self.date_orderadd_estimateddelivery = ttk.DateEntry(frame, bootstyle="SUCCESS", dateformat="%Y-%m-%d", startdate=datetime.today())
