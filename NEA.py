...
class Application(ttk.Window):
    ...
    def show_main_window(self, user): 
        ...
        self.button_main_products = ttk.Button(self.content_frame, text="Products", command=self.show_products)
    ...
    def display_products(self):
        columns = ('SKU', 'Name', "Price/SQM", "Description", "Additional Details")
        self.tree_products_list = ttk.Treeview(self.content_frame, columns=columns, show="headings")
        self.tree_products_list.pack(fill=BOTH, expand=True, padx=10, pady=10)

        for column in columns: 
            self.tree_products_list.heading(column, text=column)
            self.tree_products_list.column(column, width=200)
        ...
        try: 
            ...
            messagebox.showerror("Error", "Encountered this: {e}")
    ...
    def save_product(self): 
        ...
        if not sku or name or price_per_sqm: 
